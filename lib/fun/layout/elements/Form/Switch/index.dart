...
import 'AnimatedSwitcher/demo.dart';
import 'Switch/demo.dart';
import 'SwitchListTile/demo.dart';
...
class SwitchPage extends StatelessWidget {
  ...
  initData(BuildContext context) {
    funLists
      ..add(FunItem(
          name: "AnimatedSwitcherDemo",
          callback: (it) {
            jumpTo(context,AnimatedSwitcherDemo());
          }))
      ..add(FunItem(
          name: "SwitchDemo",
          callback: (it) {
            jumpTo(context,SwitchDemo());
          }))
      ..add(FunItem(
          name: "SwitchListTileDemo",
          callback: (it) {
            jumpTo(context,SwitchListTileDemo2());
          }));
  }
