...
import 'BottomNavigationBar/demo.dart';
import 'BottomNavigationBarItem/demo.dart';
...
class NavigationPage extends StatelessWidget {
  ...
  initData(BuildContext context) {
    funLists
      ..add(FunItem(
          name: "BottomNavigationBarFullDefault",
          callback: (it) {
            jumpTo(context,BottomNavigationBarFullDefault());
          }))
      ..add(FunItem(
          name: "BottomNavigationBarItemLessDefault",
          callback: (it) {
            jumpTo(context,BottomNavigationBarItemLessDefault());
          }));
  }
