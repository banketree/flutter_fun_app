...
import 'CircularProgressIndicator/demo.dart';
import 'LinearProgressIndicator/demo.dart';
  ...
  initData(BuildContext context) {
    funLists
      ..add(FunItem(
          name: "CircularDemo",
          callback: (it) {
            jumpTo(context,CircularDemo());
          }))
      ..add(FunItem(
          name: "LinearProgressIndicatorDemo",
          callback: (it) {
            jumpTo(context,LinearProgressIndicatorDemo());
          }));
  }
